 ...
 * Date: 2025-11-26
 *
 * TypeScript interfaces defining the pagination component API.
...
/**
 * Slots for Pagination component
 */
export interface PaginationSlots {
  /** Default slot for pagination content */
  default?: () => unknown
...
/**
 * Slots for PaginationLink component
 */
export interface PaginationLinkSlots {
  /** Custom content (page number by default) */
  default?: (props: { page: number; isActive: boolean }) => unknown
}
...
/**
 * ARIA attributes for pagination components
 */
...
export interface PaginationLinkAriaProps {
...
export interface PaginationNavigationAriaProps {
